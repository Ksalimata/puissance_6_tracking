	...
	<div class="right_col" role="main">
            ...
            <div class="page-title">
              <div class="title_left">
                <h3>Modifier des utilisateurs</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="create-user" method="post" action="{{route('user.update',$user->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                      {{csrf_field()}}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="password" class="form-control col-md-7 col-xs-12" type="text" name="password" value="{{$user->password}}">
                        </div>
                      </div>
                      <div class="form-group">
